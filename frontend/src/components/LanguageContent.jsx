...
const participantsDataEng = [
    ...
    { name: 'Pudel Roman',          role: 'Engineer'                },
    { name: 'Chernov Rustam',       role: '-'                       },
    { name: 'Dorofeyev Maksim',     role: '-'                       },    
...
const participantsDataRus = [
    ...
    { name: 'Пудель Роман',          role: '-'                      },
    { name: 'Чернов Рустам',       role: '-'                        },
    { name: 'Дорофеев Максим',     role: '-'                        },
